        ...
        public static IList<TaskViewModel> AsList { get; } = new TaskViewModel[]
        {
            new TaskViewModel(
                flavor: "<p>Wir wissen, dass du noch keine Anstellung an deinem neuen Wohnort gefunden hast. " +
                    "Aber keine Angst: Die Schoggifabrik vorort stellt dich als beinahe schon Schweizer sehr gerne ein. "+
                    "Da du im Portfolio schreibst es falle dir leicht neue Programmiersprachen zu lernen, " +
                ...
                input: "Keinen Input", output: "Den exakten String <span class=\"highlight\">\"Herzlich Willkommen!\"</span> (ohne Anführungszeichen). Dieser muss auf dem Standard-Output ausgegeben werden.",
